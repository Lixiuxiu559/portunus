...
const emptyForm = { name: '', strategy: 'manual' };

export default function CreateGroupModal({ isOpen, onOpenChange, onCreated }) {
  ...
  const handleSubmit = async () => {
    ...
    setSaving(true);
    try {
      await createGroup({ name: form.name.trim(), strategy: form.strategy });
      setForm(emptyForm);
      onOpenChange(false);
      onCreated?.();

...
import { Button, Typography, Chip, toast } from '@heroui/react';
import { Plus, Trash2, Pencil, RotateCw, X } from 'lucide-react';
                  ...
                  {g.items.map((item) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        {g.active_item_id === item.id && (
                          <Chip size="sm" color="primary" variant="soft" className="text-xs">当前活跃</Chip>
                        )}
                      </div>
                      <div className="flex items-center gap-1">
                        {g.active_item_id !== item.id && (
                        ...
                        <button
                          aria-label={`移除模型`}
                          onClick={() => handleRemoveItem(g.id, item.id)}
